            ...
            {game ? (
                ...
                <section id={game.items.item.id} key={game.items.item.id}>
                    <div className="game-info-box">
                        ...
                        >
                            <h6 className="icon-text">close</h6>
                        </span>
                            ...
                            <div className="info-top">
                                <h3 className="game-title">
                                    {game.items.item.image && game.items.item.image ? (
                                        ...
                                        // </a>
                                        <Link to={game.items.item.image} target={'_blank'}>
                                            {game.items.item.name.value}
                                        </Link>
                                    ) : (
                                        ''
                        ...
                        <div className="modal-info">
                            {game.items.item.link.map((ele, i) => {
                                return ele.type === 'boardgamedesigner' ? (
                                    <h6 key={i} className="info-designer">
                                        Designer: {ele.value}
                                    </h6>
                                ) : (
                                    ''
                            ...
                            <h6
                                className={
                                    !show.moreInfo ? 'info-more-info' : 'info-more-info hide'
                                }
                                onClick={() => {
                                    setShow({ ...show, moreInfo: !show.moreInfo });
                                }}
                            >
                                {!show.moreInfo ? 'More Info' : 'hide'}
                            </h6>
                            ...
                            {show.moreInfo && (
                                <FadeIn>
                                    <section className="more-info">
                                        ...
                                        <h6
                                            className={
                                                !show.art ? 'info-artist' : ' hide info-artist'
                                            }
                                            onClick={() => {
                                        ...
                                        <h6
                                            className={
                                                !show.pub ? 'info-publisher' : 'info-publisher hide'
                                            }
                                            onClick={() => {
                                        ...
                                        <h6
                                            className={
                                                !show.ex ? 'info-expansion' : 'info-expansion hide'
                                            }
                                            onClick={() => {
                            ...
                            <h6
                                className={
                                    !show.desc ? 'description-button' : 'description-button hide'
                                }
                                onClick={() => {
