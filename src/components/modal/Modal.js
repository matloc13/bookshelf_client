                ...
                <FadeIn>
                    <div className="game-modal" key={game.id}>
                        ...
                        <div className="modal-info">
                            ...
                            <h6
                                className={
                                    !hide.moreInfo ? 'info-more-info' : 'info-more-info hide'
                                }
                                onClick={() => {
                                    setHide({ ...hide, moreInfo: !hide.moreInfo });
                                }}
                            >
                                {!hide.moreInfo ? 'More Info' : 'hide'}
                            </h6>
                            {hide.moreInfo && (
                                <FadeIn>
                                    <section className="more-info">
                                        ...
                                        <h6
                                            className={
                                                !hide.art ? 'info-artist' : 'info-artist hide'
                                            }
                                            onClick={() => {
                                        ...
                                        <h6
                                            className={
                                                !hide.pub ? 'info-publisher' : 'info-publisher hide'
                                            }
                                            onClick={() => {
                                        ...
                                        <h6
                                            className={
                                                !hide.ex ? 'info-expansion' : 'info-expansion hide'
                                            }
                                            onClick={() => {
                            ...
                            <h6
                                className={
                                    !hide.desc ? 'description-button' : 'description-button hide '
                                }
                                onClick={() => {
