        ...
        <div className="search-results-container">
            ...
            <FadeIn>
                    ...
                    ? array[page - 1].map((ele, i) => {
                          return (
                              ...
                              >
                                  ...
                                  >
                                      <span className="title" id={`showModal`}>
                                          {ele.name.value}
                                      </span>
                                      <b></b>
                                      {ele.yearpublished && (
                                          <span className="year">
                                              <span className="property-text"> year: </span>
                                              {ele.yearpublished.value}
                                          </span>
                                      )}
                                      <b></b>
                                      <span className="id">
                                  ...
                                  {seeForms ? (
                                      ...
                                      >
                                          ...
                                          <span className="search-arrow-container">
                                              {page > 1 ? i + pl * (page - 1) + 1 : i + 1}
                                          </span>
                                      </div>
                                  ) : (
                                      <div className="forms-box">
                                          {game && ele.id === game.items.item.id ? (
                                              <div className="forms">
                ...
                {status && array.length === 0 && (
                    <li>
                        <span className="year">No results from this search.</span>
                    </li>
                )}
            </FadeIn>
            {/* </ul> */}
